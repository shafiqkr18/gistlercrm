...
<div id="wrapper">
            ...
            <!-- Info Message Alert -->
             ...
             <div role="alert" class="alert alert-info alert-dismissible fade in" id="sha" style="display:none;">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control input-sm" id="frequency" name="frequency">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <label>Cheques <a href="javascript:void(0)" data-toggle="modal" data-target="#cheques_pop"><i class="fa fa-plus-circle"></i></a></label>
                  ...
                  <div class="modal-body">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <select class=" form-control input-sm " id="prop_status" name="prop_status">
                      ...
                      <div class="row">
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control input-sm " id="source_of_listing" name="source_of_listing">
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control input-sm " id="flcheck" name="flcheck">
                      ...
                      <div class="row">
                          ...
                          <div class="form-group">
                            ...
                            <select class=" form-control input-sm" id="remind_me" name="remind_me">
         ...
         <?php echo  form_close();?>
            ...
            <a href="javascript:void(0);" id="share_options" class="dropdown-toggle click" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-share-alt"></i> Share Options</a><span class="caret"></span>
              ...
              <ul class="dropdown-menu">
                ...
                <li id="datashare_options_default" keyAccess="true"><a href="javascript:void(0);" data-target="#share_excel_all" data-toggle="modal" class="popup_a">

                	<i class="fa fa-file-excel-o"></i> Download all listing(s) as Excel table</a>
            ...
            <li class="dropdown" id="dataaction_options"> 
                ...
                <a href="" class="dropdown-toggle btn btn-success click" id="action_options" data-toggle="dropdown">Action <i class="fa fa-chevron-down"></i></a>
                  ...
                  <!--  <li><a href="#" data-toggle="modal" data-target="#add_contracts">Add Contracts</a></li>-->
                    ...
                    <li><a href="#" rel='popup15' id="copy_listing_popupid" class="popup_a" data-toggle="modal" data-target="#copy_listing_popup">Copy Listing</a></li> -->
...
//                        });
            ...
            $(document.body).on('click', '#add_agent_signature', function(){
                ...
                $.get(config.siteUrl+"common/validate_agent/" + agent_id, function(json) {
						...
						+ ' on  +' +  json.ccode + ' ' + json.mobile_no + ' ' + ( (json.office_no) ? ' / ' + json.office_no : '') ;

                                  
                                 if(json.web !='')
                                 {
                                aData  =  aData+  ' or visit ' +json.web  + ' for further details';
                                }
...
<script>
        ...
        $(document).ready(function() {
            ...
            $('#listings_row').change(function(){
                    ...
                    $('#ExportToCSV').html('<div style="display:none;" id="downloadCSV_animation"><img src="'+mainurl+'mydata/images/ajax-loader.gif" width="48" height="48" /><br>Download CSV in progress. Please wait.</div><a id="downloadCSV_div" class="popup_a" href="'+mainurl+'generate/exportCSV?type_listing=1&exportCSV='+value+'"><img src="'+mainurl+'mydata/images/excel_big.png?ts=10" width="32" height="32"><br>Download </a>'); // update download button link
                ...
                <div class="modal-content ">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="as_source_of_listing" type="text"  class="advance_search form_select_fields form-control input-sm" id="as_source_of_listing">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="advance_search form-control input-sm" id="as_baths"       name="as_baths">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="advance_search form-control input-sm datepicker"  id="as_available_date_to" name="as_available_date_to">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="advance_search form-control input-sm" id="as_max_deposit" name="as_max_deposit">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="advance_search form-control input-sm" id="as_max_bua" name="as_max_bua">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="advance_search form-control input-sm" id="as_max_uap" name="as_max_uap">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="advance_search form-control input-sm" id="as_max_ps" name="as_max_ps">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="advance_search form-control input-sm" id="as_view"    name="as_view" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="advance_search form-control input-sm" id="as_photos"      name="as_photos">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="advance_search form-control input-sm" id="as_temp_ref"    name="as_temp_ref">
              ...
              <div class="modal-dialog">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" id="save_columns_settings" data-dismiss="modal"><i class="fa fa-save"></i> Save</button>
              ...
              <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content ">
                  ...
                  <div class="modal-header">
                    ...
                    <p>To download all listings as pdf,Please click the icon. </p>
        ...
        <div class="col-md-3 col-xs-12 form-label">Email From</div>
            ...
            <div class="col-md-9 col-xs-12 one-row">
                 ...
                 <label class="">
                               ...
                               <input name="sentfrom" id="sentfromUser3"  checked="checked" value="" type="radio"  >

                                <span class="lbl padding"><?php echo $this->session->userdata('email');?></span>

                            </label> <br />

                 <label class="">

                               <input id="sentFromCompany3" name="sentfrom" type="radio"  value="property@gistler.com">

                                <span class="lbl padding">property@gistler.com<!-- property@royalhome.ae --></span>
...
//                     dibaled beds for 'Hotel apartment' and 'Land Commercial'           
 ...
 $(document).ready(function(){
                    ...
                    var this_screen_listing_id='<?php echo $copy_rentals_id;?>';

                    //alert(this_screen_listing_id);
                             ...
                             validate =  $("#myForm").validate({rules: { price: { number: true }, size: { number: true },
							  ...
							  errorPlacement: function(error, element) {
                                ...
                                if(!priceCheck) {
                                   ...
                                   alert("Please validate cheques first!");
                                    ...
                                    return false;
									 ...
									 if(lookup && validate ){
                                            ...
                                            $('#errortxt').text('You cannot edit this listing. This listing belongs to another user.');
                                       ...
                                       if(0 == 0 && (1==2 || 1==1 ||  json.agent_id == 1448804) ){
                                           ...
                                           $('.sms_owner_link').hide();
                                                                    ...
                                                                    if(type=="archived"){
                                                                        ...
                                                                        $('#errortxt').text('You cannot edit this archived listing. To edit it, click Actions - Unarchive to move the listing to the Current Listings tab.');
...
$("#showDocuments").append('<div id="doc_div_'+id.document_name+'"><div style="border-bottom:#999 dashed 1px; padding: 0px 0px 5px 0px; margin: 5px 5px 0px 5px;" ><div style="display:inline-block;" id="shafi_'+id.document_name+'" >'+id.document_name+'</div><div  style="display:inline-block; float:right;"></div><div  style="display:inline-block; float:right;"><a href="'+id.document_link+'" target="_blank">Download</a> | <a id='+id.document_link+' name='+id.document_link+' class="delete_list" href="# S"> Delete </a></div></div></div>');
                                                            ...
                                                            //agents can not edit others data
                                                            console.log(json.agent_id+"---"+admid);
        if(config.user.user_access == 3)
        {
            if(json.agent_id!=admid){
                                //hide some informain
                                $('#vlead').hide();
                                $('#landlord_name').val('- -');
                                $('#unit').val('- -');
                                ...
                                $('#vlead').show();
                                $('#forma').css('display', 'inline');
                                $('#edit').css('display', 'inline'); 
                                $('#edit, #add_options_div, #view_options_div, #copy_listing_span').css('display', '');
                                $('#errorMsg').css('display', 'none');
                            }                                                   
                        }  
