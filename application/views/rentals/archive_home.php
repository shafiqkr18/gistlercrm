	 ...
	 $('td:eq(5)', row).html( '<img title="Shared Property" id="imgunpub" src="<?php echo base_url();?>mydata/images/ss.png">' );
	  ...
	  return row;
         ...
         "columns": [
            ...
            "iDisplayLength": 25,
            "bServerSide": true,
            "sAjaxSource": config.siteUrl+"listings/datatable_archive?type=rentals&ts="+Math.round((new Date()).getTime() / 100),
            "iDisplayStart": 0,
          ...
          <!---For common use we keep entry form section as partial view to include all over as that i same-->
            ...
            <div class="inner_tab_nav">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="<?php echo site_url('listings/archived-rentals');?>">Archived Listings</a></li>
            ...
            <div class="row">
            <div class="col-md-8">
            <!--we do not have this area for functions on table-->
            </div>
            <div class="col-md-4">
