<script src="<?php echo site_url();?>js_module/PM/pm_tenants.js"></script>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-10">
          <div class="page_head_area">
            <h1><i class="fa fa fa-home"></i> Property Management - Tenants  </h1>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="tab-content tab-white">
          <div class="row">
            <div class="col-lg-12">
              <button type="button" id="newTenant" data-toggle="modal" data-target="#tenantModal" class="btn btn-lg btn-primary"><i class="fa fa-plus-circle"></i> Add Tenant</button>
              <button style="display:none;" type="button" id="editTenant" data-toggle="modal" data-target="#tenantModal" class="btn btn-lg btn-warning"><i class="fa fa-plus-circle"></i>Edit Tenant</button>
              <button style="display:none;" type="button" id="cancelTenant" class="btn btn-lg btn-default"><i class="fa fa-plus-circle"></i> Cancel</button>
            </div>
          </div>
          <div class="row">
            <h4 class="add_new_rental">Property Management - Tenants</h4> </div>
          <div class="row fadeInUp">
            <div class="col-md-3">
              <div class="panel panel-default">
                <div class="panel-heading"><i class="fa fa-home"></i> Tenant Details
                ...
                <div id="divTenantDetails" class="panel-body pmp-samehieght">
            ...
            <div class="col-md-6">
              <div class="panel panel-default" style="height:150px">
                <div class="panel-heading"><i class="fa fa-group"></i> Leased Unit
                    <div class="panel-option"> 
                        <span class="pull-right clickable">
                            <i class="glyphicon glyphicon-chevron-up"></i>
                        </span> 
      ...
      <div class="row fadeInUp">
        <div class="inner_tab_nav">
          ...
          <li value="0" class="active"><a href="#" value="0">All Tenants <span id="cntAll" class="text-info">(<?php echo $all;?>)</span></a></li>
          </ul>
        </div>
        <div class="tab-content tab-white"> 
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <label id="modaltitle">
            <h4 class="modal-title">Add Tenant Information</h4>
          </label>
        </div>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-success" data-dismiss="modal" id="btnSaveTenant"><i class="fa fa-check"></i> Save and Close</button>
        </div>
      </div>
    </div>
  </div>
