    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-10">
          <div class="page_head_area">
            <h1><i class="fa fa fa-home"></i> Property Management - Servives Providers  </h1>
      ...
      <div class="row">
        ...
        <div class="tab-content tab-white">
          <div class="row">
            <div class="col-lg-12">
              <button type="button" id="newServiceProvider" data-toggle="modal" data-target="#serviceprovidermodal" class="btn btn-lg btn-primary"><i class="fa fa-plus-circle"></i> Add SP</button>
              <button style="display:none;" type="button" id="editServiceProvider"  data-toggle="modal" data-target="#serviceprovidermodal"  class="btn btn-lg btn-warning"><i class="fa fa-plus-circle"></i>Edit SP</button>
              <button  style="display:none;" type="button" id="cancelServiceProvider" class="btn btn-lg btn-default"><i class="fa fa-plus-circle"></i> Cancel</button>
          ...
          <div class="row">
            <h4 class="add_new_rental">Property Management - Services</h4></div>
            ...
            <div class="row fadeInUp">
              ...
              <div class="col-md-3">
                <div class="panel panel-default">
                  <div class="panel-heading"><i class="fa fa-home"></i> Services Provider Details
                  ...
                  <div id="divSPDetails" class="panel-body pmp-samehieght">

                    <div class="form-group">
                      <label>Ref</label>
                      <input type="text" class="form-control input-sm" id="ref" disabled="disabled">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control input-sm" id="subtypes" name="subtypes">
                    </div>
                    <div class="form-group">
                      <label>Address</label>
                    ...
                    <div class="form-group">
                     ...
                     <input type="hidden" id="mobilenumber1">
                     <input type="text" class="form-control input-sm" id="mobilenumbertitle" name="mobilenumbertitle">
                   </div>
                   <div class="form-group">
                    <label>Email</label>
            ...
            <div class="col-md-6">
              <div class="panel panel-default" style="height:185px">
                <div class="panel-heading"><i class="fa fa-cog"></i> Work Orders
                  <div class="panel-option">
                    <span class="pull-right clickable">
                      <i class="glyphicon glyphicon-chevron-up"></i>
                    </span>
                ...
                <div class="panel-body tab-nopadding pmp-samehieght">
                  ...
                  <div class="panel panel-default gist-formsmartpanel gist-leasetabs" style="height: 140px">
                    <div class="panel-heading panel-gistab gist-contab">
                      <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#workinpro" aria-controls="workinpro" role="tab" data-toggle="tab">In Progress</a></li>
                        <li role="presentation"><a href="#workcomp" aria-controls="workcomp" role="tab" data-toggle="tab">Completed</a></li>

                      </ul>
                    </div>
                    <div id="divWorkOrders" class="panel-body">
                      <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="workinpro">

                          <div class="gist-showmeonclick personalcontent">
                            <div id="divWorkOrderInProgressHeader" class="tab-nopadding">
                              <span class="text-warning">No Work Orders in progress</span>
                              <div id="divWorkOrderInProgressDetails" style="display:none; width: 100%; height: 270px;  overflow: auto; overflow-x:visible;">
                        ...
                        <div role="tabpanel" class="tab-pane" id="workcomp">

                          <div class="gist-showmeonclick workcontent">
                            <div id="divWorkOrderCompletedHeader" class="tab-nopadding">
                              <span class="text-warning">No Work Orders completed</span>
                              <div id="divWorkOrderCompletedDetails" style="display:none;width: 100%; height: 270px;  overflow: auto; overflow-x:visible;">
                                <table class="table table-striped">
                                  <thead>
                                    <tr>
                                      <td>Priority </td>
                    ...
                    <div class="panel-body">
                      <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="tabAll">
                          <div class="gist-showmeonclick personalcontent">
                            <div id="divAllTransactionsdHeader" class="tab-nopadding">
                              <span class="text-warning">No Transactions</span>
                              <div id="divAllTransactionsDetails" style="display:none; overflow: auto; overflow-x:visible;">
                                <table class="table table-striped">
                                  <thead>
                                    <tr>
                                      <td>Ref </td>
                        ...
                        <div role="tabpanel" class="tab-pane" id="tabPending">
                          ...
                          <div class="gist-showmeonclick workcontent">
                            <div id="divPendingTransactionsHeader" class="tab-nopadding">
                              <span class="text-warning">No Pending Transactions</span>
                              <div id="divPendingTransactionsDetails" style="display:none; overflow: auto; overflow-x:visible;">
                                <table class="table table-striped">
                                  <thead>
                                    <tr>
                                      <td>Ref </td>
                        ...
                        <div role="tabpanel" class="tab-pane" id="tabPaid">
                          <div class="gist-showmeonclick othercontent">
                            <div id="divPaidTransactionsdHeader" class="tab-nopadding">
                              <span class="text-warning">No Paid Transactions</span>
                              <div id="divPaidTransactionsDetails" style="display:none; overflow: auto; overflow-x:visible;">
                                <table class="table table-striped">
                                  <thead>
                                    <tr>
                                      <td>Ref </td>
      ...
      <div class="row fadeInUp">
        <div class="inner_tab_nav">
          <ul class="nav nav-tabs">
            <li class="active"><a href="current_listing.html">All Services Providers <span class="text-info"><!-- (6) --></span></a></li>

          </ul>
        </div>
        <div class="tab-content tab-white"> 
          <div style="Save Report"> <input style="width:300px" 
            class="form-control input-sm search_init" type='text' id='txtSmartSearch_serviceproviders' 
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <div class="modal-body">
              ...
              <div class="tab-content tab-nopadding">
                ...
                <div class="clear"></div> <!-- to fix overflow issue -->
              </div>
            </div>
          ...
          <div class="modal-footer">
            <button type="button" id="btnSaveServiceProvider" class="btn btn-success" data-dismiss="modal"><i class="fa fa-check"></i> Save and Close</button>
          </div>
        </div>
      </div>
    </div>