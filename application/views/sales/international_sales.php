...
<div id="wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                	<div class="page_head_area"><h1><i class="fa fa-home"></i>International Sales</h1></div>
                </div>
            </div>
            ...
            <div class="inner_tab_nav">
                <ul class="nav nav-tabs">
                    ...
                    <li  class="active"><a href="<?php echo site_url('listings/international-sales');?>">International</a></li>
        ...
        ?>
            ...
            <div class="row">
              <div class="col-md-6">
                  <div class="form-group">
                    <label>Price / <span id="measuringunitlabel">sq ft</span></label>
                    <input class="form-control input-sm price" type="text" name="sqf" id="sqf" readonly="" style="display:none" value="sq ft" alt="" disabled="">
             ...
             <div class="row">
              <div class="col-md-12">
                    ...
                    <div class="input-group">
                      <input name="postcode" type="text" class="form-control " id="postcode" value="" maxlength="180" tabindex="23">
                    </div>
                    </div>
              </div>
