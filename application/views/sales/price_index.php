...
var search_done             = false;
 ...
 <div id="wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                	<div class="page_head_area"><h1><i class="fa fa-home"></i> Sales Price Index</h1></div>
                </div>
            </div>
           ...
           <!-- Error Message Alert -->
            ...
            <div class="inner_tab_nav">
              ...
              <li><a href="<?php echo site_url('listings/sales');?>">United Arab Emirates</a></li>
                    ...
                    <li class="active"><a href="<?php echo site_url('listings/price-index-sales');?>">Sales Price Index</a></li>
                </ul>
            </div>
        ...
        <div class="form-actions row"></div>
            ...
            <div class="inner_tab_nav">
                <ul class="nav nav-tabs">
                    <li  class="active"><a href="<?php echo site_url('listings/price-index-sales');?>">Market Data</a></li>
                    <!-- <li><a href="<?php echo site_url('listings/compare-sales');?>">Compare Your Listing</a></li> -->
                </ul>
            </div>
