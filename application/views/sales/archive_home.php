...
function toggleChecked_archive(status) {
	    $("#listings_archive_row input").each( function() {
		$(this).attr("checked",status);
		}); 
}

function refresh_archive_datatable(){
        var oTable_archive = $('#listings_archive_row').dataTable();
        oTable_archive.fnDraw();
}	
/*******************datatable js here*/
	 ...
	 $('td:eq(5)', row).html( '<img title="Shared Property" id="imgunpub" src="<?php echo base_url();?>mydata/images/ss.png">' );
	  ...
	  return row;
         ...
         "columns": [
            ...
            "iDisplayLength": 25,
            "bServerSide": true,
            "sAjaxSource": config.siteUrl+"listings/datatable_archive?type=sales&ts="+Math.round((new Date()).getTime() / 100),
            "iDisplayStart": 0,
		...
		$('#listings_archive_row th input').click(function(event) {
    event.stopPropagation();
     });
		/* start min and max functions*/
	       var asInitVals = new Array();
			$("#listings_archive_row thead input").keyup( function () {
					oTable_archive.fnFilter( this.value, parseInt($(this).attr('id')) );

				} );
				
				
				$("#listings_archive_row thead input").each( function (i) {
					asInitVals[i] = this.value;
				} );
				
				$("#listings_archive_row thead input").focus( function () {
				...
				$("#listings_archive_row thead input").blur( function (i) {
					if ( this.value == "" )
					{
				...
				//$("#show_unapproved_listings").live("click", function() {
//					oTable_archive.fnFilter( "3", 1 );
//					$('#listings_archive_row #reset_filter').css('display', '');
//					 });
//					 $('#imgunpub').live("click", function() {
//					oTable_archive.fnFilter( '1', parseInt(1) );
//					 });
//					 //publish
//					 $('#imgpub').live("click", function() {
//					oTable_archive.fnFilter( '2', parseInt(1) );
//					 });
//					 //unapp
//					 $('#unapp').live("click", function() {
//					oTable_archive.fnFilter( '3', parseInt(1) );
//					 });
//					 //managed and unmanaged
//					 $('#unman').live("click", function() {
//					oTable_archive.fnFilter( '0', parseInt(2) );
//					 });
//					 $('#man').live("click", function() {
//					oTable_archive.fnFilter( '1', parseInt(2) );
//					 });
//					 //end man/unmanaged
//					 //exclusiv
//					  $('#unexc').live("click", function() {
//					oTable_archive.fnFilter( '0', parseInt(3) );
//					 });
//					 $('#exc').live("click", function() {
//					oTable_archive.fnFilter( '1', parseInt(3) );
//					 });
//					 //end exclusiv
//					 //share
//					  $('#unsh').live("click", function() {
//					oTable_archive.fnFilter( '0', parseInt(3) );
//					 });
...
//					 });
	...
	//$("#listings_archive_row .sorting").live("click", function(event){
//		oTable_archive.fnFilter( $(this).attr('value'), $(this).attr('id_search') );
//		//alert($(this).attr('id_search'))
//		$('#'+$(this).attr('id_search')+'_archive img').attr('src', $(this).attr('image'));
//		$('#listings_archive_row  #1').val($(this).attr('value'));
//		$('#listings_archive_row #reset_filter').css('display', '');
//
//	} );
	...
	$("#listings_archive_row thead input").keyup( function () {
		...
		oTable_archive.fnFilter( this.value, $(this).attr('id') );
		$('#listings_archive_row #reset_filter').css('display', '');
	} );
$('#listings_archive_row').change(function(){
		  // alert('chang');
		   $('#id').val($(this).val());
		   });

	$("#listings_archive_row thead select").change( function () {
		/* Filter on the column (the index) of this element */
		oTable_archive.fnFilter( this.value, $(this).attr('id') );
		$('#listings_archive_row #reset_filter').css('display', '');
	} );
	...
	$("#listings_archive_row #reset_filter").click(function () {
			$("#listings_archive_row #myForm2")[ 0 ].reset();
			oTable_archive.fnDraw(false);
    		oTable_archive.fnFilterClear(true);
			$("#listings_archive_row .click img").attr("src", "<?php echo base_url();?>mydata/images/arrow.png");
			$('#listings_archive_row #reset_filter').css('display', 'none');
	});

	//$("#listings_archive_row tbody tr, .overflow").live("click", function(event){
//		
//		  $("td.yellowCSS", oTable_archive.fnGetNodes()).removeClass("yellowCSS");
//		  $('#listings_archive_row tbody #'+$(this).attr('rel')).find("td").addClass("yellowCSS");
...
<div id="wrapper">
            ...
            <div class="inner_tab_nav">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="<?php echo site_url('listings/price-index-sales');?>">Rental Price Index</a></li>
                </ul>
            </div>
         ...
         <!-- For common use we keep entry form section as partial view to include all over as that i same -->
            ...
            <div class="inner_tab_nav">
                <ul class="nav nav-tabs">
                     <li ><a href="<?php echo site_url('listings/sales');?>" >Current Listings</a></li>

                    <li class="active"><a href="<?php echo site_url('listings/archived-sales');?>">Archived Listings</a></li>
            ...
            <li class="dropdown" id="dataaction_options"> 
                <a href="" class="dropdown-toggle btn btn-success click" id="action_options" data-toggle="dropdown">Action <i class="fa fa-chevron-down"></i></a>
                  <ul class="dropdown-menu">
                    <!-- <li><a href="#" id='add_task_popup_link' rel='add_task_popup'class="popup_a" data-toggle="modal" data-target="#add_todo">Add To-Do</a></li>
                    ...
                    <li><a href="#" id='add_lead_popup_link' rel='add_lead_popup'class="popup_a" data-toggle="modal" data-target="#add_leads">Add Lead</a></li>
                 
                    <li><a href="#" id='add_deal_popup_link' rel='add_deal_popup'class="popup_a" data-toggle="modal" data-target="#add_deals">Add Deal</a></li>
                    <li class="divider"></li>
            ...
            <div class="row">
                ...
                <table class="table table-striped table-hover datatables datatable-setbotclass dataTable no-footer" aria-describedby="dataTables-current-listing_info" id="listings_archive_row">
                  ...
                  <tr>
                    ...
                    <th><div style="cursor:pointer; min-width:40px;" title="Click here to sort">Archived</div></th>
