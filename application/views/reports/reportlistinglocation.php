     ...
     <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-body">
          <div class="col-md-12">
            <h3 class="gist-reportinghead">Listings By Listing Locations</h3>
            <div class="row">
              <div class="col-xs-1">
                <div class="form-group">
                  <select class=" form-control">
                    <option data-content="<img src='<?php echo base_url()?>images/uae.png'>">Dubai</option>
                    <option data-content="<img src='<?php echo base_url()?>images/usa.png'>">International</option>
                  </select>
                </div>
              </div>
            </div>
                  ...
                  <div class="customize-right colx-xs-12 col-md-11">
                    <div class="ember-view groups-listing">    
                      <div class="filter-group-main">
                        <div class="filter-title">Group by:<span> Type </span></div>
                      </div>
                      <div class="filter-group-main filter-sep">
                        <div class="filter-title">Sub-Grouped by: <span>Location</span>
                        ...
                        <div class="filter-group-main">
                          <button class="btn btn-success btnPopulateTable" id="ListingLocation"> <span aria-hidden="true" class="glyphicon glyphicon-ok"></span> Apply </button>
                        </div>
                      </div>
                    </div>
                  </div>
