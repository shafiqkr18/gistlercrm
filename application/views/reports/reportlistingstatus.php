     ...
     <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-body">
          <div class="col-md-12">
            <h3 class="gist-reportinghead">Listings By Listing report status</h3>
            <div class="row">
              <div class="col-xs-1">
                ...
                <div class="repviewfilter-sep"> 
                  ...
                  <div class="customize-right colx-xs-12 col-md-11">
                    <div class="ember-view groups-listing">    
                      ...
                      <div class="filter-group-main">
                        <button class="btn btn-success btnPopulateTable" id="ListingStatus"> <span aria-hidden="true" class="glyphicon glyphicon-ok"></span> Apply </button>
                      </div>
                    </div>
                  </div>
                </div>
