...
}return t.rec_type&&scheduler._roll_back_dates(t),scheduler.checkCollision(t)}),scheduler._check_sections_collision=function(e,t){var a=scheduler._get_section_property();return e[a]==t[a]&&e.id!=t.id?!0:!1},scheduler.checkCollision=function(e){var a=[],i=scheduler.config.collision_limit;if(e.rec_type)for(var n=scheduler.getRecDates(e),l=0;l<n.length;l++)for(var r=scheduler.getEvents(n[l].start_date,n[l].end_date),d=0;d<r.length;d++)(r[d].event_pid||r[d].id)!=e.id&&a.push(r[d]);else{a=scheduler.getEvents(e.start_date,e.end_date);
